...
export default function TopBanner(){
    return(
        <div className="flex justify-center px-3 md:px-8 lg:px-20 xl:px-20 2xl:px-56 pt-10 lg:mt-14 m-2 ">
            <div className="flex justify-between  flex-wrap lg:flex-nowrap"> 
                <div className=" md:w-10/12 lg:w-7/12 xl:w-5/12">
                    <h1 className="font-readex_bold text-fontColor text-5xl md:text-7xl lg:text-7xl 2xl:text-8xl ">Plan Less.<br/>Travel More.</h1>

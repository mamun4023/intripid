                ...
                <div className= "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-12  ">
                    <div className= "col-span-3">
                        <div className= "text-center md:text-start lg:text-left">
                            ...
                            <div className="my-6 w-full md:w-8/12 lg:w-60">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-6">
                ...
                <div className="md:col-span-4 mt-4">
                    ...
                    <div className="w-32 md:w-40">
                        ...
                        <div>
                            <div className="mt-2 leading-4"> 
                                <a className="text-xs text-fontColor leading-none hover:underline" href="#"> Personalized Destinations </a>
                            </div>
                            <div className="mt-2 leading-4">
                                <a className="text-xs text-fontColor hover:underline" href="#"> Expert Travel Advisors </a>
                            </div>
                    ...
                    <div className="w-32 md:w-40 mt-4 2xl:mt-0 ">
                        ...
                        <div>
                            ...
                            <div className="mt-2 leading-4"> 
                                <a className="text-xs text-fontColor hover:underline" href="#"> Security </a>
                            </div>
                        </div>
                    </div>
